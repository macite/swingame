...
implementation
  ...
  begin
    ...
    _KeyCode[LongInt(Num0Key)]          := LongInt(SDLK_0);
    _KeyCode[LongInt(Num1Key)]          := LongInt(SDLK_1);
    _KeyCode[LongInt(Num2Key)]          := LongInt(SDLK_2);
    _KeyCode[LongInt(Num3Key)]          := LongInt(SDLK_3);
    _KeyCode[LongInt(Num4Key)]          := LongInt(SDLK_4);
    _KeyCode[LongInt(Num5Key)]          := LongInt(SDLK_5);
    _KeyCode[LongInt(Num6Key)]          := LongInt(SDLK_6);
    _KeyCode[LongInt(Num7Key)]          := LongInt(SDLK_7);
    _KeyCode[LongInt(Num8Key)]          := LongInt(SDLK_8);
    _KeyCode[LongInt(Num9Key)]          := LongInt(SDLK_9);
